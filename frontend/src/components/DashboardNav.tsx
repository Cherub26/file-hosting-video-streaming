      ...
      <div className="flex items-center gap-6">
        {user && (
          <>
            ...
            <Link to="/my-files" className="text-blue-600 font-medium hover:underline hidden md:inline">Tenant Files</Link>
            <Link to="/my-videos" className="text-blue-600 font-medium hover:underline hidden md:inline">Tenant Videos</Link>
            <Link to="/tenants" className="text-blue-600 font-medium hover:underline hidden md:inline">Tenants</Link>
          </>
        )}
      </div>
          ...
          <div className="relative" ref={menuRef}>
            ...
            {open && (
              <div className="absolute right-0 mt-2 w-48 bg-white text-blue-600 rounded-xl shadow-lg z-50 py-2 animate-fade-in border border-blue-100" style={{ minWidth: '12rem' }}>
                ...
                <Link to="/my-videos" className="flex items-center gap-2 px-4 py-2 hover:bg-blue-50 transition text-base hover:text-blue-800">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7" /></svg>
                  Tenant Videos
                </Link>
                <Link to="/tenants" className="flex items-center gap-2 px-4 py-2 hover:bg-blue-50 transition text-base hover:text-blue-800">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7" /></svg>
                  Tenants
                </Link>
                <button
